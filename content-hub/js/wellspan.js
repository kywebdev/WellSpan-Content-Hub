$(document).ready(function(){
    ...
    $('.filter-bar .container form ul li').on( 'click', 'input', function() {
        ...
        $container.isotope({ filter: countyValue + ', .pinned' });
    ...
    $checkboxes.change(function () {
        ...
        $container.isotope({ filter: '.pinned' + ', ' + filterValue });

        console.log('.pinned' + ', ' + filterValue);
    });
    ...
    function secondaryFilterOnLoad(countyValue) {
        $checkboxes.change(function () {
            ...
            $container.isotope({ filter: filterValue + countyValue + ', .pinned' });
            console.log(filterValue + countyValue + ', .pinned');
        });
    }
    ...
    function secondaryFilter(filterValue) {
        $('.filter-bar .container form > ul li').on( 'click', 'input', function() {
            ...
            $radios.change(function () {
                ...
                $container.isotope({ filter: countyValue + filterValue + ', .pinned' });
                console.log(countyValue + filterValue + ', .pinned');
            });
        });
    }
    ...
    // play youtube video when poster image is clicked
    $('.hero.video').click(function(){
        $('#player + .container').hide();
        $('header + .container').addClass('aspect-ratio');
    ...
    function onPlayerStateChange(event) {
        if(event.data == YT.PlayerState.ENDED) {
            ...
            $('header + .container').removeClass('aspect-ratio');
